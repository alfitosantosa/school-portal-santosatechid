...
import { useGetSchedulesByTeacher } from "@/app/hooks/Schedules/useSchedules";
...
export default function CalendarPage() {
  ...
  const { data: schedules = [], isLoading: schedulesLoading } = useGetSchedulesByTeacher(userData?.id ?? "");
